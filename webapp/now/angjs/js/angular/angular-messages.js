 ...
 * used with `ngMessages` to display control error messages in an easier way than with just regular angjs
 * template directives.
 *
 * ```html
 * <form name="myForm">
...
angular.module('ngMessages', [])
    ...
    * ```
    *
    * @param {string} ngMessages an angjs expression evaluating to a key/value object
    ...
    *   </file>
    *   <file name="script.js">
    *     angjs.module('ngMessagesExample', ['ngMessages']);
    *   </file>
    * </example>
    */
